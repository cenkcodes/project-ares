...
$Package = Join-Path $ScriptRoot "xurvexa-video-sitemap-v2.1-server.zip"
$ExpectedPackageSha = "0da4624470ff8e26d1f8b6f19bbc6bcf99e1361aaf46cc0bb140c3574e8b5084"
$RemotePackage = "/tmp/xurvexa-video-sitemap-v2.1-server.zip"
$RemoteDir = "/tmp/xurvexa-video-sitemap-v2.1"

Write-Host "===== VIDEO SITEMAP V2.1 WINDOWS DEPLOY ====="
...
$RemoteCommand = "command -v python3 >/dev/null 2>&1 && rm -rf $RemoteDir && mkdir -p $RemoteDir && python3 -m zipfile -e $RemotePackage $RemoteDir && bash $RemoteDir/deploy.sh"
...
Write-Host ""
Write-Host "VIDEO_SITEMAP_V2_1_WINDOWS_DEPLOY=PASS"
