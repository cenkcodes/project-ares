<x-filament-panels::page>
    ...
    <div class="xrv-dashboard xrv-traffic-v2">
        ...
        <section class="xrv-section">
            ...
            <div class="xrv-note">
                ...
                Traffic V2 began collecting data only
                after the analytics layer was enabled.
                Earlier traffic is not reconstructed.
                Video Detail Views mean video detail
                page opens, not verified player starts.
            ...
            <div class="xrv-card-grid">
                ...
                <div class="xrv-card">
                    ...
                    <div class="xrv-card-help">
                        Distinct consented anonymous
                        visitor IDs in this period.
                    </div>
                </div>
                ...
                <div class="xrv-card">
                    ...
                    <div class="xrv-card-help">
                        Visitors not classified as
                        returning in this reporting
                        window.
                    </div>
                </div>
                ...
                <div class="xrv-card">
                    ...
                    <div class="xrv-card-help">
                        @if($range === 'all')
                            Visitors with at least two
                            tracked analytics sessions.
                        @else
                            Visitors seen before this
                            reporting window and active
                            again within it.
                        @endif
                    </div>
                </div>
                ...
                <div class="xrv-card">
                    ...
                    <div class="xrv-card-help">
                        Video-viewing sessions that
                        reached at least a second video
                        detail page.
                    </div>
                </div>
        ...
        <section class="xrv-section">
            ...
            <div class="xrv-section-heading">
                ...
                <span class="xrv-dashboard-muted">
                    Selected-period video detail views
                </span>
        ...
        <section class="xrv-section">
            ...
            <div class="xrv-section-heading">
                ...
                <h2>
                    Legacy Video Counter
                </h2>

                <span class="xrv-dashboard-muted">
                    Pre-V2 all-time detail-page counter
                </span>
            ...
            <div class="xrv-note">
                ...
                measurement. Consent-based visitor
                and session metrics are provided
                separately in Traffic Analytics V2
                above.
